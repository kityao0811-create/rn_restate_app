...
export const FeatureCard = ({ onPress }: Props) => {
    return (
        <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative mt-4'>
            ...
            <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
                ...
                <Text className='text-base font-rubik text-white'>22 Jalan PJU 10/12C</Text>
    ...
    return (
        <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
            ...
            <View className='flex flex-col items-start mt-2'>
                <Text className='text-base font-bold text-black-300' numberOfLines={1}>Cozy Studio</Text>
                <Text className='text-xs font-rubik text-black-200'>22 Jalan PJU 10/12C</Text>

                <View className='flex flex-row items-center justify-between mt-2 w-full'>
                    <Text className='text-xl font-bold text-primary-300'>$2,500</Text>
